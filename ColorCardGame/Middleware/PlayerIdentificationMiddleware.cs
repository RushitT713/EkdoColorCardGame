...
namespace ColorCardGame.Middleware
{
    public class PlayerIdentificationMiddleware
    {
        private readonly RequestDelegate _next;
        private const string PlayerIdCookieName = "ColorCard_PlayerId";
        ...
        public async Task InvokeAsync(HttpContext context, IStatsService statsService)
        {
            ...
            await statsService.GetOrCreatePlayerAsync(playerId);
